namespace Vidly.Migrations
{
    ...
    public partial class AddMemberShipTypeIdUpdated : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Customers", "MembershipTypeIds");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Customers", "MembershipTypeIds", c => c.Byte(nullable: false));
